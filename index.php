...
function displayArticles($category) {
    ...
    // sortira po datumu (najnoviji na vrhu)
    $query = "SELECT * FROM vijesti WHERE arhiva=0 AND kategorija=? ORDER BY datum DESC LIMIT 4";
...
displayArticles('sport');
displayArticles('kultura');
